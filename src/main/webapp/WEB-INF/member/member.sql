...
--insert into member values(default, 'admin', 'asdf1234', '관리인', '관리자', '남자', default,
--'010-2999-8992', '28575 충청북도 청주시 서원구 사직대로 109, 4층', 'jhm714@naver.com', '관리자입니다.',
--default, default, default, default, default, default, default, default, default);

update member set point = 100;
update member set visitCnt = 0;
update member set todayCnt = 0;
