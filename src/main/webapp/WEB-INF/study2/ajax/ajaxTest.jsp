...
//	브라우저 프로토콜 중 하나인 XMLHttpRequest 이용하는 방법
    function idCheck1() {
    	let mid = myform.mid.value.trim();
    	let flag = idCheck(mid);
...
//				timeOut : 10000,
				...
				success : function(res) {
					console.log("mid(ajax처리 후) : " + res);
					let str = "<font color='red'>검색 아이디 : " + mid + ", 성명 : <b>" + res + "</b></font>"; 
					$("#demo").html(str);
				},
  ...
  <div>
    <form name="myform">
      ...
      <div>
        ...
        <input type="button" value="포인트 우수 검색1" onclick="pointCheck1()" class="btn btn-info mr-2 mb-2"/>
        <input type="button" value="포인트 우수 검색2" onclick="pointCheck2()" class="btn btn-warning mr-2"/>
      </div>
    </form>
    <hr/>
    <div id="demo"><font color="red">출력결과(검색된 성명) : <b>${param.name}</b></font></div>
  </div>
  <hr/>
  <pre>
