...
<head>
  ...
  <title>test1.jsp</title>
	...
	<script>
  	...
  	function fCheck(flag) {
  		...
  		if(flag == 1) {
  			...
  			location.href = "${ctp}/stduy/mapping/Test1";
  		}
		}
  </script>
</head>
	...
	<div class="container">
  	...
  	<hr>
  	<div class="row">
  		<div class="col"><input type="button" value="두 수의 합/차" onclick="fCheck(1)" class="btn btn-success mr-2"/></div>
  		<div class="col"><input type="button" value="돌아가기" onclick="fCheck(2)" class="btn btn-primary mr-2"/></div>
  		<div class="col"><input type="button" value="두 수의 곱/몫" onclick="fCheck(3)" class="btn btn-warning mr-2"/></div>
  		<div class="col"><input type="button" value="전송2" onclick="fCheck(4)" class="btn btn-info mr-2"/></div>
  	</div>
  	<hr>
  	<div>
  		<form action="${ctp}/mapping/Test1Ok" name="myform" method="post">
