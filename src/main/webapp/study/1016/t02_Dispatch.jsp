...
<div class="container">
  ...
  <form name="myform" method="post" action="<%=request.getContextPath()%>/1016/T01Ok1">
    ...
    <div>
      <button type="submit" class="form-control btn-success mb-2">로그인1(post)</button>
      <button type="button" onclick="fCheck()" class="form-control btn-info mb-2">로그인2(post)</button>
